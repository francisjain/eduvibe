...
const HomeOne = () => {
  ...
  return (
    <div>
      ...
      >
        <img decoding="async" src="	https://eduvibe.devsvibe.com/main/wp-content/uploads/2022/10/shape-circle-2.png" alt="" height="541" width="541" loading="lazy" className='absolute top-52 -left-[96px] mix-blend-darken hidden md:block' />


        <img decoding='async' loading='lazy' src="https://eduvibe.devsvibe.com/main/wp-content/uploads/2022/10/shape-03-2.png" alt="" className='absolute top-48 right-12 hidden lg:block' />
        <img decoding='async' loading='lazy' src="https://eduvibe.devsvibe.com/main/wp-content/uploads/2022/10/shape-04-2.png" alt="" className='absolute bottom-48 right-9 hidden lg:block' />

        <img decoding='async' loading='lazy' src="https://eduvibe.devsvibe.com/main/wp-content/uploads/2022/10/shape-05-05-2.png" alt="" className='absolute bottom-40 -left-2 hidden sm:block' />
        <img decoding='async' loading='lazy' src="https://eduvibe.devsvibe.com/main/wp-content/uploads/2022/10/shape-01-2.png" alt="" className='absolute top-44 -left-3 hidden lg:block' />


        <div className='pt-[55px] md:pt-[105px]  w-full  flex justify-center items-center pb-8 overflow-hidden'>
          <div className='w-full max-w-[1338px] xl:ml-[124px]  flex flex-wrap  gap-7 md:gap-0 '>

            <div className='m-auto md:m-0  flex flex-col flex-wrap p-[15px] w-[500px] md:w-1/2 xl:w-[45%]  order-2 md:order-1'>
              <span className='text-[#525FE1] text-base tracking-[1.6px] font-extrabold	px-[10px] mb-4'>EXCELLENCE IN EDUCATION</span>
              <h1 className='text-[42px] md:text-5xl lg:text-7xl font-extrabold text-[#231F40] ml-1 mb-8 lg:leading-[85px]'>Start Better Learning Future From Here</h1>
              <p className='text-[#6F6B80] text-xl ps-5 border-l-2 border-[#525FE1] mb-11'>Empower yourself with the knowledge and skills gained through online education! The key to your future!</p>
            ...
            <div className='m-auto md:m-0 md:w-1/2 xl:w-[55%]  flex flex-wrap sm:flex-nowrap relative   order-1 md:order-2'>

              <div className='flex flex-col justify-center items-center gap-6 mx-2 sm:mr-0 sm:ml-10 relative'>
                <img decoding='async' loading='lazy' src="https://eduvibe.devsvibe.com/main/wp-content/uploads/2022/10/shape-02-2.png" alt="" className='absolute -top-12 -left-12 hidden sm:block' />

                <img decoding='async' loading='lazy' src="https://eduvibe.devsvibe.com/main/wp-content/uploads/2022/10/shape-05-2.png" alt="" className='absolute -bottom-5 left-0 hidden md:block' />

                <div className='bg-white shadow-[0 10px 30px rgb(0 0 0 / 6%)] p-[15px] rounded-md md:w-[277px] img-expand'>
                  <div className='overflow-hidden rounded-md object-contain cursor-pointer relative'>

                    <a href="# " className='absolute z-10 top-2 left-2 text-white font-semibold bg-[#525FE1] rounded-sm text-sm lead px-3 leading-[30px]'>UI Design</a>
                    <img decoding="async" loading="lazy" src="https://eduvibe.devsvibe.com/main/wp-content/uploads/2023/03/course-33-590x430.webp" alt="" className=' img1' />
                  </div>

                  <div className="flex flex-col ">
                    <ul className="flex text-sm text-[#6F6B80] font-semibold mt-3">
                      <li className='py-[5px] px-[6px] flex justify-center items-center'><PostAddRoundedIcon sx={{ fontSize: "18px", color: "#F86F03", marginRight: "8px" }} />19 Lessons</li>
                      <li className='py-[5px] px-[6px] flex justify-center items-center'><AccessTimeRoundedIcon sx={{ fontSize: "18px", color: "#F86F03", marginRight: "8px" }} />15 hour</li>
                    </ul>
                    <h4 className="text-[#231F40] text-lg font-bold mt-[10px] mb-3"><a href="# ">Learning How To Write As A Professional Author</a></h4>
                    <div className="text-sm text-[#6F6B80] font-medium mb-[5px]">
                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore...</p>
                    </div>
                  </div>
                </div>

                <div className='flex flex-col bg-white p-5 max-w-[200px] rounded-[5px]'>
                  <img decoding='async' loading='lazy' width={"40px"} height="40px" src="https://eduvibe.devsvibe.com/main/wp-content/uploads/2022/10/workshop-2.png" alt="" />
                  <h4 className="text-[#231F40] text-lg font-bold mt-[10px] mb-1">Design Workshop</h4>
                  <div className="text-sm text-[#6F6B80] font-medium mb-5">
                    <p>Today at 6:00 am</p>
                  </div>
                  <a class="bg-[#F86F03] text-center text-white font-semibold text-sm  py-[10px] px-[13px] max-w-fit rounded-[5px]" href="# ">Join Now<ArrowForwardRoundedIcon sx={{ fontSize: "16px" }} /></a>
                </div>

              </div>

              <img decoding='async' loading='lazy' src="https://eduvibe.devsvibe.com/main/wp-content/uploads/2022/10/video-image-2.png" alt="" className='m-auto md:absolute top-2 left-[307px] ' />
        ...
        <div className='flex justify-center items-center mt-24'>
          <a href="#section2" className='absolute'>
          <IconButton className='bg-white rounded-full hover:bg-white' sx={{ backgroundColor: "white", padding: "18px", boxShadow: "0 10px 20px rgb(0 0 0 / 7%)",  zIndex: 2 }}>
            <KeyboardArrowDownRoundedIcon className='text-[#525Fe1]' />
          </IconButton>
          </a>
        </div>
      ...
      <div className='w-full grid place-content-center py-44 px-[15px]' id='section2'>
